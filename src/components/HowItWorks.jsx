...
const HowItWorks = () => {
  return (
    <section className="mx-6 mt-[700px] mb-[120px] md:mt-[500px] md:mx-10 lg:mt-56 lg:mx-20">
      <h2 className="text-grey font-Fraunces font-black text-2xl text-center md:text-left">
        How it works
      </h2>
      <div className="hidden md:block relative w-[600px] h-1 bg-pale-orange my-14 xl:w-[950px]">
      ...
      <div className="grid grid-cols-1 gap-14 mt-20 md:grid-cols-3">
        <Step
          number="01"
