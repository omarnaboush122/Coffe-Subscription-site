...
const Steps = () => {
  return (
    <section className="bg-black mt-14 rounded-md md:my-36 lg:mx-20">
      <div className="hidden md:block relative top-20 left-14 w-[70%] h-[2px] bg-pale-orange my-14">
        <span className="absolute -top-[15px] left-0 w-8 h-8 bg-black rounded-full border-2 border-solid border-dark-cyan"></span>
        <span className="absolute -top-[15px] left-[50%] w-8 h-8 bg-black rounded-full border-2 border-solid border-dark-cyan"></span>
        <span className="absolute -top-[15px] left-[98%] w-8 h-8 bg-black rounded-full border-2 border-solid border-dark-cyan"></span>
      </div>
